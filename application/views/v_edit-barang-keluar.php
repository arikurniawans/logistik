 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Barang Keluar<br/>
        <small>ubah data logistik barang keluar</small>
      </h1>
      <ol class="breadcrumb">
...
<form method="post" action="<?php echo base_url(); ?>barangkeluar/changetransaksi">
    <div class="box-tools pull-right">
        <button typw="submit" <?php if($batas == 0){ echo 'disabled'; } ?> class="btn btn-block btn-flat btn-info"><i class="fa fa-fw fa-save"></i> Simpan Perubahan Data Barang Keluar</buttom>
    </div><br/><br/>
      <!-- Default box -->
      <div class="row">
            <div class="col-md-5">
                                ...
                                <tr>
                                    ...
                                    <div class="modal fade" id="hapusbarang<?php echo $keluar->id_cart; ?>">
                                        <div class="modal-dialog">
                                            ...
                                            <form action="<?php echo base_url(); ?>barangkeluar/delete" method="post">
  ...
  <div class="modal fade" id="modal-lg">
          <div class="modal-dialog">
            <div class="modal-content">
            <form action="<?php echo base_url(); ?>barangkeluar/changecart" method="post">
              ...
              <div class="modal-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Nama Barang</label>
                    <input type="hidden" name="nosurat" value="<?php echo $nosurat; ?>"/>
