...
<head>
  ...
  <title>Aplikasi Stok Opname Logistik | POLRES Pesawaran</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Aplikasi</b> SO</span>
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  <small><?php echo ucwords($this->session->userdata('user_status')); ?></small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
